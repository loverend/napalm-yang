...
with the MPLS dataplane
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__exp','__in_pkts','__in_octets','__out_pkts','__out_octets',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__exp = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'0..7']}), is_leaf=True, yang_name="exp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', original_module='openconfig-segment-routing', yang_type='uint8', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'mpls', u'signaling-protocols', u'segment-routing', u'interfaces', u'interface', u'sid-counters', u'sid-counter', u'forwarding-classes', u'forwarding-class', u'state']
...
corresponds to an SR Segment Identifier.
  ...
  _pyangbind_elements = {'exp': exp, 'in_pkts': in_pkts, 'in_octets': in_octets, 'out_pkts': out_pkts, 'out_octets': out_octets, }
