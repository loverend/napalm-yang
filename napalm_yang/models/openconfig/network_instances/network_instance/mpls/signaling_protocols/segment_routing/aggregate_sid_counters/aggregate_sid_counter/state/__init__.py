...
class state(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'mpls', u'signaling-protocols', u'segment-routing', u'aggregate-sid-counters', u'aggregate-sid-counter', u'state']

  def _get_mpls_label(self):
    """
    Getter method for mpls_label, mapped from YANG variable /network_instances/network_instance/mpls/signaling_protocols/segment_routing/aggregate_sid_counters/aggregate_sid_counter/state/mpls_label (oc-mpls-t:mpls-label)
  ...
  def _set_mpls_label(self, v, load=False):
    """
    Setter method for mpls_label, mapped from YANG variable /network_instances/network_instance/mpls/signaling_protocols/segment_routing/aggregate_sid_counters/aggregate_sid_counter/state/mpls_label (oc-mpls-t:mpls-label)
