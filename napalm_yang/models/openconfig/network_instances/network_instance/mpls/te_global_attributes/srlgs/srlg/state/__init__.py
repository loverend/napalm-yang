...
class state(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'mpls', u'te-global-attributes', u'srlgs', u'srlg', u'state']
