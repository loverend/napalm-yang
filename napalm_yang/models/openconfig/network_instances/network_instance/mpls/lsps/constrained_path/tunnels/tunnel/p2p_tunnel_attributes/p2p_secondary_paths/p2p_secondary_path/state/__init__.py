...
that details of the signaling can be retrieved.
  ...
  def _set_associated_rsvp_session(self, v, load=False):
    """
    Setter method for associated_rsvp_session, mapped from YANG variable /network_instances/network_instance/mpls/lsps/constrained_path/tunnels/tunnel/p2p_tunnel_attributes/p2p_secondary_paths/p2p_secondary_path/state/associated_rsvp_session (leafref)
    If this variable is read-only (config: false) in the
