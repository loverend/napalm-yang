...
class p2p_secondary_path(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__config','__state','__admin_groups',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'mpls', u'lsps', u'constrained-path', u'tunnels', u'tunnel', u'p2p-tunnel-attributes', u'p2p-secondary-paths', u'p2p-secondary-path']
...
link affinities
  ...
  _pyangbind_elements = {'name': name, 'config': config, 'state': state, 'admin_groups': admin_groups, }
