...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/interfaces/interface/levels/level/packet-counters/cnsp/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Packet counters relating to CNSPs.
  """
  ...
  def _set_received(self, v, load=False):
    """
    Setter method for received, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/levels/level/packet_counters/cnsp/state/received (yang:counter32)
...
that have been processed by the local system.
  ...
  def _set_processed(self, v, load=False):
    """
    Setter method for processed, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/levels/level/packet_counters/cnsp/state/processed (yang:counter32)
    If this variable is read-only (config: false) in the
...
that have been dropped.
  ...
  def _set_dropped(self, v, load=False):
    """
    Setter method for dropped, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/levels/level/packet_counters/cnsp/state/dropped (yang:counter32)
    If this variable is read-only (config: false) in the
...
local system on the interface.
  ...
  def _set_sent(self, v, load=False):
    """
    Setter method for sent, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/levels/level/packet_counters/cnsp/state/sent (yang:counter32)
    If this variable is read-only (config: false) in the
...
retransmitted by the local system on the interface.
  ...
  def _set_retransmit(self, v, load=False):
    """
    Setter method for retransmit, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/levels/level/packet_counters/cnsp/state/retransmit (yang:counter32)
    If this variable is read-only (config: false) in the
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/interfaces/interface/levels/level/packet-counters/cnsp/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
