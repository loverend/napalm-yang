...
of prefixes from IS-IS Level 2 to Level 1.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__import_policy','__default_import_policy',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'protocols', u'protocol', u'isis', u'global', u'inter-level-propagation-policies', u'level2-to-level1', u'state']
...
in the import policy chain is satisfied.
  ...
  _pyangbind_elements = {'import_policy': import_policy, 'default_import_policy': default_import_policy, }
