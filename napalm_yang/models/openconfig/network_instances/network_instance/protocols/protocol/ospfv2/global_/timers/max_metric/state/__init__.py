...
OSPFv2 maximum metric for a set of advertised entities.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'protocols', u'protocol', u'ospfv2', u'global', u'timers', u'max-metric', u'state']
