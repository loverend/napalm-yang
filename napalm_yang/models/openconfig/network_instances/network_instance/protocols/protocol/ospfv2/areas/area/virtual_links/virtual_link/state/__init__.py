...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__remote_router_id','__priority','__dead_time','__designated_router','__backup_designated_router','__optional_capabilities','__last_established_time','__adjacency_state','__state_changes','__retranmission_queue_length',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'protocols', u'protocol', u'ospfv2', u'areas', u'area', u'virtual-links', u'virtual-link', u'state']
