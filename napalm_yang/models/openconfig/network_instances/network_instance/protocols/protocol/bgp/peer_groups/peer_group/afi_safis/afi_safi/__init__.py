...
neighbour or group
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'protocols', u'protocol', u'bgp', u'peer-groups', u'peer-group', u'afi-safis', u'afi-safi']
...
for the AFI-SAFI list
  ...
  def _get_route_selection_options(self):
    """
    Getter method for route_selection_options, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/afi_safis/afi_safi/route_selection_options (container)
  ...
  def _set_route_selection_options(self, v, load=False):
    """
    Setter method for route_selection_options, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/afi_safis/afi_safi/route_selection_options (container)
    If this variable is read-only (config: false) in the
...
depending on the context.
  ...
  _pyangbind_elements = {'afi_safi_name': afi_safi_name, 'config': config, 'state': state, 'graceful_restart': graceful_restart, 'route_selection_options': route_selection_options, 'use_multiple_paths': use_multiple_paths, 'apply_policy': apply_policy, 'ipv4_unicast': ipv4_unicast, 'ipv6_unicast': ipv6_unicast, 'ipv4_labeled_unicast': ipv4_labeled_unicast, 'ipv6_labeled_unicast': ipv6_labeled_unicast, 'l3vpn_ipv4_unicast': l3vpn_ipv4_unicast, 'l3vpn_ipv6_unicast': l3vpn_ipv6_unicast, 'l3vpn_ipv4_multicast': l3vpn_ipv4_multicast, 'l3vpn_ipv6_multicast': l3vpn_ipv6_multicast, 'l2vpn_vpls': l2vpn_vpls, 'l2vpn_evpn': l2vpn_evpn, }
