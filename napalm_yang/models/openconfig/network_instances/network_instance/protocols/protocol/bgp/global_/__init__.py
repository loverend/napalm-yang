...
import afi_safis
import dynamic_neighbor_prefixes
class global_(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__default_route_distance','__confederation','__graceful_restart','__use_multiple_paths','__route_selection_options','__afi_safis','__dynamic_neighbor_prefixes',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'protocols', u'protocol', u'bgp', u'global']
