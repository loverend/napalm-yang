...
class members(PybindBase):
  ...
  from YANG module openconfig-vlan - based on the path /vlans/vlan/members. Each member element of
...
associated with the VLAN.
  ...
  def _set_member(self, v, load=False):
    """
    Setter method for member, mapped from YANG variable /vlans/vlan/members/member (list)
