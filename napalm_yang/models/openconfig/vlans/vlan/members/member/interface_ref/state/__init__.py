...
class state(PybindBase):
  ...
  from YANG module openconfig-vlan - based on the path /vlans/vlan/members/member/interface-ref/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vlans', u'vlan', u'members', u'member', u'interface-ref', u'state']

  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /vlans/vlan/members/member/interface_ref/state/interface (leafref)
...
to indicate the base interface.
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /vlans/vlan/members/member/interface_ref/state/interface (leafref)
...
to indicate the base interface.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/vlan', defining_module='openconfig-vlan', original_module='openconfig-interfaces', yang_type='leafref', is_config=False)
  ...
  def _get_subinterface(self):
    """
    Getter method for subinterface, mapped from YANG variable /vlans/vlan/members/member/interface_ref/state/subinterface (leafref)
...
is requuired, this leaf should not be set.
  ...
  def _set_subinterface(self, v, load=False):
    """
    Setter method for subinterface, mapped from YANG variable /vlans/vlan/members/member/interface_ref/state/subinterface (leafref)
    If this variable is read-only (config: false) in the
...
is requuired, this leaf should not be set.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="subinterface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/vlan', defining_module='openconfig-vlan', original_module='openconfig-interfaces', yang_type='leafref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
