...
class state(PybindBase):
  ...
  from YANG module openconfig-vlan - based on the path /vlans/vlan/state. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__name = YANGDynClass(base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/vlan', defining_module='openconfig-vlan', original_module='openconfig-vlan', yang_type='string', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vlans', u'vlan', u'state']

  def _get_vlan_id(self):
    """
    Getter method for vlan_id, mapped from YANG variable /vlans/vlan/state/vlan_id (oc-vlan-types:vlan-id)
  ...
  def _set_vlan_id(self, v, load=False):
    """
    Setter method for vlan_id, mapped from YANG variable /vlans/vlan/state/vlan_id (oc-vlan-types:vlan-id)
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /vlans/vlan/state/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /vlans/vlan/state/name (string)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/vlan', defining_module='openconfig-vlan', original_module='openconfig-vlan', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/vlan', defining_module='openconfig-vlan', original_module='openconfig-vlan', yang_type='string', is_config=False)""",
        })
  ...
  def _get_status(self):
    """
    Getter method for status, mapped from YANG variable /vlans/vlan/state/status (enumeration)
  ...
  def _set_status(self, v, load=False):
    """
    Setter method for status, mapped from YANG variable /vlans/vlan/state/status (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_tpid(self):
    """
    Getter method for tpid, mapped from YANG variable /vlans/vlan/state/tpid (identityref)
...
is accepted on the VLAN
  ...
  def _set_tpid(self, v, load=False):
    """
    Setter method for tpid, mapped from YANG variable /vlans/vlan/state/tpid (identityref)
    If this variable is read-only (config: false) in the
