...
class ipv6(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__addresses','__neighbors','__unnumbered','__config','__state','__autoconf',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interfaces', u'interface', u'subinterfaces', u'subinterface', u'ipv6']
...
address information
  ...
  _pyangbind_elements = {'addresses': addresses, 'neighbors': neighbors, 'unnumbered': unnumbered, 'config': config, 'state': state, 'autoconf': autoconf, }
