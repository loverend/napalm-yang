...
with a physical interface
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__index','__config','__state','__vlan','__ipv4','__ipv6',)
...
data on subinterfaces
  ...
  _pyangbind_elements = {'index': index, 'config': config, 'state': state, 'vlan': vlan, 'ipv4': ipv4, 'ipv6': ipv6, }
