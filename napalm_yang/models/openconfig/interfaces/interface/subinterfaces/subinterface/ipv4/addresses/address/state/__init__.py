...
configured on the interface
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interfaces', u'interface', u'subinterfaces', u'subinterface', u'ipv4', u'addresses', u'address', u'state']

  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /interfaces/interface/subinterfaces/subinterface/ipv4/addresses/address/state/ip (inet:ipv4-address-no-zone)
...
The IPv4 address on the interface.
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /interfaces/interface/subinterfaces/subinterface/ipv4/addresses/address/state/ip (inet:ipv4-address-no-zone)
