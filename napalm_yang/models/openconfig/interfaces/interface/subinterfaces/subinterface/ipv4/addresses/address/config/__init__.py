...
address on the interface
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__ip','__prefix_length','__secondary',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__secondary = YANGDynClass(base=YANGBool, default=YANGBool("false"), is_leaf=True, yang_name="secondary", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='https://github.com/napalm-automation/napalm-yang/yang_napalm/interfaces', defining_module='napalm-if-ip', original_module='napalm-if-ip', yang_type='boolean', is_config=True)
...
The IPv4 address on the interface.
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /interfaces/interface/subinterfaces/subinterface/ipv4/addresses/address/config/ip (inet:ipv4-address-no-zone)
...
on the same interfaces
  ...
  def _set_secondary(self, v, load=False):
    """
    Setter method for secondary, mapped from YANG variable /interfaces/interface/subinterfaces/subinterface/ipv4/addresses/address/config/secondary (boolean)
    If this variable is read-only (config: false) in the
...
on the same interfaces
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, default=YANGBool("false"), is_leaf=True, yang_name="secondary", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='https://github.com/napalm-automation/napalm-yang/yang_napalm/interfaces', defining_module='napalm-if-ip', original_module='napalm-if-ip', yang_type='boolean', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """secondary must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, default=YANGBool("false"), is_leaf=True, yang_name="secondary", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='https://github.com/napalm-automation/napalm-yang/yang_napalm/interfaces', defining_module='napalm-if-ip', original_module='napalm-if-ip', yang_type='boolean', is_config=True)""",
        })
