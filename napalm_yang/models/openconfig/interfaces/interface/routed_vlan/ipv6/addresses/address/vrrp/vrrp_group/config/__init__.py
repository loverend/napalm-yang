...
VRRP group
  ...
  def _set_virtual_address(self, v, load=False):
    """
    Setter method for virtual_address, mapped from YANG variable /interfaces/interface/routed_vlan/ipv6/addresses/address/vrrp/vrrp_group/config/virtual_address (inet:ip-address)
    If this variable is read-only (config: false) in the
...
address
  ...
  def _set_virtual_link_local(self, v, load=False):
    """
    Setter method for virtual_link_local, mapped from YANG variable /interfaces/interface/routed_vlan/ipv6/addresses/address/vrrp/vrrp_group/config/virtual_link_local (inet:ip-address)
    If this variable is read-only (config: false) in the
