...
class config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interfaces', u'interface', u'routed-vlan', u'ipv4', u'addresses', u'address', u'vrrp', u'vrrp-group', u'config']
...
generated for the VRRP group
  ...
  def _get_virtual_address(self):
    """
    Getter method for virtual_address, mapped from YANG variable /interfaces/interface/routed_vlan/ipv4/addresses/address/vrrp/vrrp_group/config/virtual_address (inet:ip-address)
...
VRRP group
  ...
  def _set_virtual_address(self, v, load=False):
    """
    Setter method for virtual_address, mapped from YANG variable /interfaces/interface/routed_vlan/ipv4/addresses/address/vrrp/vrrp_group/config/virtual_address (inet:ip-address)
    If this variable is read-only (config: false) in the
