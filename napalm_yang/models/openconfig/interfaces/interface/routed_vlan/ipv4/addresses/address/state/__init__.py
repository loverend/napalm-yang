...
configured on the interface
  ...
  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /interfaces/interface/routed_vlan/ipv4/addresses/address/state/ip (inet:ipv4-address-no-zone)
...
The IPv4 address on the interface.
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /interfaces/interface/routed_vlan/ipv4/addresses/address/state/ip (inet:ipv4-address-no-zone)
