...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__mac_address','__auto_negotiate','__duplex_mode','__port_speed','__enable_flow_control','__hw_mac_address','__effective_speed','__negotiated_duplex_mode','__negotiated_port_speed','__counters','__aggregate_id',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__counters = YANGDynClass(base=counters.counters, is_container='container', yang_name="counters", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/interfaces/ethernet', defining_module='openconfig-if-ethernet', original_module='openconfig-if-ethernet', yang_type='container', is_config=False)
...
expected to show the system-assigned MAC address.
  ...
  def _set_mac_address(self, v, load=False):
    """
    Setter method for mac_address, mapped from YANG variable /interfaces/interface/ethernet/state/mac_address (yang:mac-address)
...
address for the Ethernet interface.
  ...
  def _set_hw_mac_address(self, v, load=False):
    """
    Setter method for hw_mac_address, mapped from YANG variable /interfaces/interface/ethernet/state/hw_mac_address (yang:mac-address)
    If this variable is read-only (config: false) in the
...
address for the Ethernet interface.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}'}), is_leaf=True, yang_name="hw-mac-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/ethernet', defining_module='openconfig-if-ethernet', original_module='openconfig-if-ethernet', yang_type='yang:mac-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """hw_mac_address must be of a type compatible with yang:mac-address""",
          'defined-type': "yang:mac-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}'}), is_leaf=True, yang_name="hw-mac-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/ethernet', defining_module='openconfig-if-ethernet', original_module='openconfig-if-ethernet', yang_type='yang:mac-address', is_config=False)""",
        })
...
negotiated speed if auto-negotiate is enabled
  ...
  def _set_effective_speed(self, v, load=False):
    """
    Setter method for effective_speed, mapped from YANG variable /interfaces/interface/ethernet/state/effective_speed (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_effective_speed is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_effective_speed() directly.
...
negotiated speed if auto-negotiate is enabled
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="effective-speed", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/ethernet', defining_module='openconfig-if-ethernet', original_module='openconfig-if-ethernet', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """effective_speed must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="effective-speed", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/ethernet', defining_module='openconfig-if-ethernet', original_module='openconfig-if-ethernet', yang_type='uint32', is_config=False)""",
        })

    self.__effective_speed = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_effective_speed(self):
    self.__effective_speed = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="effective-speed", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/ethernet', defining_module='openconfig-if-ethernet', original_module='openconfig-if-ethernet', yang_type='uint32', is_config=False)
...
this interface belongs
  ...
  effective_speed = __builtin__.property(_get_effective_speed)
